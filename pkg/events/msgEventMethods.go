...
func (d *MessageHandler) testMethod(session *discordgo.Session, message *discordgo.MessageCreate) {
...
func (d *MessageHandler) sendHelpMessage(session *discordgo.Session, message *discordgo.MessageCreate) error {
	var cmds []string
...
func (d *MessageHandler) sendLmgtfy(session *discordgo.Session, message *discordgo.MessageCreate) error {
...
func (d *MessageHandler) coinFlip(session *discordgo.Session, message *discordgo.MessageCreate) error {
...
func (d *MessageHandler) sendGif(session *discordgo.Session, message *discordgo.MessageCreate, param string) error {
...
func (d *MessageHandler) displayHoroscope(session *discordgo.Session, message *discordgo.MessageCreate, param string) error {
...
func (d *MessageHandler) playYoutubeLink(session *discordgo.Session, message *discordgo.MessageCreate, param string) error {
...
func (d *MessageHandler) sendStartUpMessages(session *discordgo.Session, message *discordgo.MessageCreate) error {
...
func (d *MessageHandler) startServer(session *discordgo.Session, message *discordgo.MessageCreate) error {
...
func (d *MessageHandler) stopServer(session *discordgo.Session, message *discordgo.MessageCreate) error {
	if d.cfg.ExternalServicesConfig.MachineIP != "" { // check if Minecraft server is set up
		sshClient, err := ssh.NewSSHClient(d.cfg.ExternalServicesConfig.SSHKeyBody, d.cfg.ExternalServicesConfig.MachineIP)
		if err != nil {
			return err
...
func (d *MessageHandler) sendServerStatusAsMessage(session *discordgo.Session, message *discordgo.MessageCreate) error {
	client, err := gcp.NewGCPClient("config/auth.json", d.cfg.GCPAuth.Project_ID, d.cfg.GCPAuth.Zone)
	if err != nil {
		return err
	}
...
func (d *MessageHandler) postInsult(session *discordgo.Session, message *discordgo.MessageCreate, memberName string) error {
